    ...
    public void setGoal(int x, int y) {
        ...
        pathFinder.searchConnectionPath(startNode, targetNode,
            ...
            public float estimate(TileNode n, TileNode n1) {
                //return 0;
                //Ou retorne a distancia da posiçao ao destino, dividido por 32 ("tamanho" do quadrado)
                return new Vector2(new Vector2(n.getPosition())).sub(new Vector2(n1.getPosition())).len()/32;
            }
        }, path);
